    ...
    if (typeof window !== "undefined") {
      ...
      const previewUrl =
        portfolio && portfolio.isPublished
          ? `/portfolio/${portfolio.subdomain || "preview"}?view=full&template=true`
          : `${window.location.origin}/api/preview/${portfolioId}?view=full&template=true`;
    ...
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-gray-900">
            ...
            <div className="hidden md:flex items-center space-x-1">
              ...
              {viewportSize === "desktop" && (
                <Button
                  variant="outline"
                  size="sm"
                  className={actualSize ? "bg-slate-100" : ""}
      ...
      <div className="container py-6 flex-1 flex flex-col md:flex-row gap-6">
        ...
        >
          ...
          {hasPaidPlan && (
            <div className="border rounded-lg bg-white dark:bg-gray-800 shadow-sm p-5">
              <div className="flex items-center space-x-3">
