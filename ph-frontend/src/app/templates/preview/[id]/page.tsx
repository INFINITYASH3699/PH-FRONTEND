...
export default function TemplatePreviewPage() {
  ...
  const features =
    templateFeatures[template.category as keyof typeof templateFeatures] ||
                  ...
                  <div className="flex">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        fill={
                          star <= Math.round(template.rating?.average || 0)
                            ? "currentColor"
                            : "none"
                        }
                        stroke="currentColor"
          ...
          <div className="container px-4 md:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground mt-2 max-w-2xl mx-auto">
                Discover all the features and capabilities that {template.name}{" "}
                has to offer
              </p>
            </div>
        ...
        <section className="py-16 bg-muted/30">
          <div className="container px-4 md:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground mt-2 max-w-2xl mx-auto">
                Take a closer look at how your portfolio can look with this
                template
              </p>
            </div>
        ...
        <section className="py-16 relative">
          ...
          <div className="container px-4 md:px-6 relative">
            <div className="max-w-3xl mx-auto text-center space-y-6">
              ...
              <p className="text-lg text-muted-foreground">
                Use this template to showcase your work and create a stunning
